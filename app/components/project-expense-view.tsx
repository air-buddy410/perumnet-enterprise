...
export function ProjectExpenseView({
  ...
  // outright; an Admin may override but must state a reason.
  const selfAuthored = (expense: ProjectExpense) =>
