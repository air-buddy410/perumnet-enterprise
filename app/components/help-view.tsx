...
const workflowsId: WorkflowGuide[] = [
  ...
  },
  {
    ...
    after: "Setiap invoice punya nomor sendiri dan mewarisi pajak yang terkunci pada penawaran. Selama belum ada pembayaran, invoice masih dapat diedit atau dihapus.",
  },
  {
    key: "invoice-payment",
    icon: WalletCards,
  ...
  },
  {
    ...
    after: "Nilai proyek bertambah dan SPK/PO baru dapat mengambil item dari addendum ini. Pekerjaan yang sudah diterima sebelumnya tetap terkunci dan angkanya tidak berubah.",
  },
  {
    key: "procurement",
    icon: PackageSearch,
    ...
    who: "Project Manager atau Engineer membuat dan mengajukan. Admin atau Finance menyetujui. Verifikasi progres dan penerimaan barang hanya oleh Project Manager atau Engineer. Pembatalan pembayaran hanya oleh Admin.",
  ...
  },
  {
    ...
    after: "BAST menjadi Final dan tidak dapat diubah, sementara status proyek berubah menjadi Selesai. Siapa pun yang memindai QR pada PDF dapat memeriksa apakah dokumen itu asli dan masih berlaku. Bila ada kekeliruan, Admin mencabut dokumennya dan tim membuat revisi baru.",
  },
  {
    key: "expenses",
    icon: HandCoins,
    ...
    who: "Project Manager atau Engineer mencatat. Admin atau Finance memverifikasi. Pembatalan belanja yang sudah disetujui hanya oleh Admin.",
    ...
    steps: [
      ...
      "Finance memeriksa nota, kategori, sumber dana, dan peringatan kemungkinan pencatatan ganda, lalu menyetujui.",
...
const workflowsEn: WorkflowGuide[] = [
  ...
  },
  {
    ...
    after: "Each invoice gets its own number and inherits the tax locked on the quotation. As long as no payment has been recorded, an invoice can still be edited or deleted.",
  },
  {
    key: "invoice-payment",
    icon: WalletCards,
  ...
  },
  {
    ...
    after: "The project value increases and new procurement documents can draw items from this addendum. Work that was already accepted stays locked and its figures do not change.",
  },
  {
    key: "procurement",
    icon: PackageSearch,
    ...
    who: "A Project Manager or Engineer creates and submits. Admin or Finance approves. Progress verification and goods receipt are done only by a Project Manager or Engineer. Only an Admin may void a payment.",
  ...
  },
  {
    ...
    after: "The certificate becomes Final and can no longer be edited, and the project status changes to Completed. Anyone who scans the QR code on the PDF can check whether the document is genuine and still valid. If something is wrong, an Admin revokes it and the team issues a new revision.",
  },
  {
    key: "expenses",
    icon: HandCoins,
    ...
    who: "A Project Manager or Engineer records them. Admin or Finance verifies. Only an Admin may void an approved purchase.",
