    ...
    <div className="document-preview-backdrop" role="dialog" aria-modal="true" aria-label={title}>
      <div className="document-preview-shell">
        ...
        <div className="document-preview-body">
          ...
          {objectUrl && (
            <object data={objectUrl} type="application/pdf" className="document-preview-frame">
              <p>Browser ini tidak mendukung pratinjau PDF. <a href={objectUrl} target="_blank" rel="noreferrer">Buka di tab baru</a>.</p>
            </object>
          )}
        </div>
      </div>
