...
export function parseMailLoginSnapshot(value: string): MailLoginSnapshot {
  ...
  const normalizeConfig = (
    ...
    headline: String(input.headline ?? "Email perusahaan untuk komunikasi kerja."),
    description: String(input.description ?? "Masuk untuk membuka email, kalender, dan kontak kerja PerumNet."),
    cardTitle: String(input.cardTitle ?? "Masuk ke akun email"),
