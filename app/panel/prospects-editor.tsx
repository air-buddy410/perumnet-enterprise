...
/**
 * `as="div"` wajib dipakai ketika isinya BUKAN satu kontrol form.
 *
 * `<label>` tanpa atribut `for` mengambil elemen labelable PERTAMA di dalamnya
 * sebagai kontrol yang ia wakili, lalu meneruskan setiap klik ke sana. Untuk
 * `<input>` biasa itu justru yang diinginkan: klik di teks labelnya memfokuskan
 * kolomnya.
 *
 * Untuk editor surat, itu mematikannya. Editornya menaruh toolbar lebih dulu,
 * dan toolbar berisi `<button>` dan `<select>` — keduanya labelable. Klik di
 * permukaan tulis diteruskan ke tombol toolbar pertama, caret tidak pernah
 * mendarat, dan kotaknya sama sekali tidak bisa diketik meski terlihat normal
 * dan tidak terkunci. Pemilik menemukannya 22 Agustus 2026.
 */
function Field({
  label,
  required = false,
